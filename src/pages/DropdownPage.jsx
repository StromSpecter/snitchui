import { DropdownDemo } from '../components/ui/dropdown/dropdown.demo.jsx'
import { CodeBlock } from '../components/ui/CodeBlock.jsx'
import { CopyButton } from '../components/ui/CopyButton.jsx'
import { components, resolveDeps } from '../constants/components.js'

export function DropdownPage() {
  const meta = components.find((c) => c.id === 'dropdown')
  ...
  return (
    <div className="mx-auto max-w-4xl px-6 py-10">
      ...
      <section className="mb-12">
        ...
        <div className="rounded-lg border border-border/50 bg-card/70 backdrop-blur-xl overflow-hidden">
          <div className="flex items-center justify-between bg-muted px-4 py-2.5 border-b border-border/50">
            ...
            <CopyButton text={meta.installCmd} label="install-dropdown" />
          </div>
      ...
      <section className="mb-12">
        ...
        <CodeBlock
          code={`import { Dropdown, DropdownTrigger, DropdownContent, DropdownItem, DropdownSeparator, DropdownLabel } from '@/components/ui/dropdown'
